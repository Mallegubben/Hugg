...
def normalize_source(raw: str) -> str:
    ...
    mapping = [
        ...
        ("kindaturism", "kindaturism"),
        ("visitlulea", "visitlulea"),
        ("backe", "backe.nu"),
        ("visitvarberg", "visitvarberg"),
        ("visitdalarna", "visitdalarna"),
        ("aneby", "aneby_kommun"),
        ("katrineholm", "katrineholm_kommun"),
        ("naturguiden", "naturguiden_ornskoldsvik"),
        ("ornskoldsvik", "naturguiden_ornskoldsvik"),
        ("solleftea", "solleftea_kommun"),
        ("fiskejournalen", "fiskejournalen"),
        ("sfk-kroken", "sfk_kroken"),
        ("sfk_kroken", "sfk_kroken"),
        ("boras", "boras_kommun"),
        ("snesudden", "snesuddenfiske"),
        ...
        ("arbetsochmiljomedicin", "amm_exponeringsbedomning"),
        ("valdemarsvik", "valdemarsvik_kommun"),
        ("miljodatabasen", "botkyrka_miljodatabas"),
        ("botkyrka", "botkyrka_kommun"),
        ("stromshammar", "stromshammar_se"),
        ("skargarden.se", "skargarden_se"),
        ("skärgården", "skargarden_se"),
        ("norran", "norran_se"),
        ("norsjo", "norsjo_kommun_lis"),
        ("slado", "slado_se"),
        ("sladö", "slado_se"),
        ("risebo", "risebo_sportfiskeguide"),
        ("sportfiskeguide", "sportfiskeguide"),
        ("lansstyrelsen sodermanland", "lst_sodermanland_fiskeguide"),
        ("sers", "SERS"),
        ("nors", "NORS"),
        ("fvo_artlista", "fvo_artlista"),
        ("langvattnetsfvo", "langvattnetsfvo_se"),
        ("dellenbygdens", "dellenbygdens_fvo"),
        ("jarvsofvo", "jarvsofvo_se"),
        ("ulvstafvof", "ulvstafvof_se"),
        ("farilafiske", "farilafiske_se"),
        ("messlingenfiske", "messlingenfiske"),
    ]
...
def load_enrichments() -> list[dict]:
    candidates = [
        ...
        RAW / "vatten_fill_round8.json",
        RAW / "vatten_fill_round9_csv_gaps.json",
        RAW / "vatten_fill_round10_kalmar_jonkoping.json",
        RAW / "vatten_fill_round10_syd.json",
        RAW / "vatten_fill_round10_norr.json",
        RAW / "vatten_fill_round11_vg.json",
        RAW / "vatten_fill_round11_ost_vb.json",
        RAW / "vatten_fill_round12_stockholm.json",
        RAW / "vatten_fill_round12_varmland.json",
        ...
        RAW / "vatten_fill_round14b.json",
        RAW / "vatten_fill_round14c.json",
        RAW / "vatten_fill_round15.json",
        RAW / "vatten_fill_round15_vg.json",
        RAW / "vatten_fill_round15_rest.json",
        RAW / "vatten_fill_round16_rest_sers.json",
        RAW / "vatten_fill_round16_vg.json",
        RAW / "vatten_fill_round16_og_kalmar_vrm.json",
        RAW / "vatten_fill_round16_norr_zero.json",
        RAW / "vatten_fill_round17_jk_kronoberg_vastmanland.json",
        RAW / "vatten_fill_round17_polygon_and_deep.json",
        RAW / "vatten_fill_round17_vg_jk_zero.json",
